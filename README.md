...
### 학생 연락 (무료·수동)
- 사물함 상세 패널과 **‘마감·임박 사물함’** 목록에서 **문자 / 전화** 버튼을 제공합니다.
- 버튼을 누르면 **직원 기기의 문자앱/전화 앱**이 **안내 문구가 채워진 채로** 열립니다.
  (마감일 안내 문구 자동 생성 — 예: “[서면 YBM] ○○님, 3층 07번 사물함 마감일이 …”)
- PC에서 문자/전화 앱이 없을 때를 위해 **‘문구 복사’** 버튼도 제공합니다.
- 자동 일괄 발송이 아니라 한 명씩 보내는 방식입니다(가입·비용 없음). 카카오 알림톡/SMS
  자동발송이 필요하면 추후 발송대행사 + Supabase Edge Function 연동으로 확장할 수 있습니다.
